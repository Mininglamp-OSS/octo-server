...
func TestMain(m *testing.M) {
	...
	if err == nil {
		...
		// The Group package imports Workspace directly but not the base module,
		// so its isolated migration set does not include the shared outbox table.
		// Keep this fixture aligned with modules/base/sql/20260909000001_event_outbox.sql.
	}
	os.Exit(m.Run())
}

...
// .octospec/tasks/card-message-protocol/brief.md）。P1 只注册展示相 7 码；
// 交互相（card_action_invalid / card_action_denied / card_seq_conflict）随
// P2 sibling 实现 PR 落地。DefaultMessage 为 en-US 源（D4），zh-CN 运行时
// 翻译在 pkg/i18n/locales/active.zh-CN.toml。
var (
	...
	// ---- modules/robot（robot ingress / 编辑路径）--------------------------

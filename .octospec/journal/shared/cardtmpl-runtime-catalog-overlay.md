...
- PR-A squash-merged through PR #674 as `68e8134d`. This branch has been
  ...
  pass before the replacement PR can merge. PR #673 was closed only to retrigger
  the repository's review automation; its validated implementation was retained.
